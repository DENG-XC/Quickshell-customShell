...
Rectangle {
    ...
    Layout.preferredWidth: leftPanel.collapsed ? parent.width - Config.sc(20) : parent.width
    Layout.preferredHeight: leftPanel.collapsed ? parent.width - Config.sc(20) : Config.toggleAppLauncher ? expandedHeight : baseHeight
    Layout.fillHeight: false
    Layout.topMargin: leftPanel.collapsed ? Config.sc(20) : 0
    Layout.alignment: Qt.AlignCenter
    radius: leftPanel.collapsed ? Config.sc(10) : Config.sc(25)
    clip: true

    property real baseHeight: Math.round(mainLayout.height / 25)
    ...
    Item {
        ...
        anchors.bottomMargin: Config.sc(10)
            ...
            delegate: Item {
                ...
                Item {
                    ...
                    Image {
                        id: appListIcon
                        anchors.horizontalCenter: parent.horizontalCenter
                        y: parent.height / 2 - Config.sc(36)
                        source: modelData.icon
                        width: Config.sc(52)
                        height: Config.sc(52)
                        sourceSize.width: Config.sc(52)
                        sourceSize.height: Config.sc(52)
                        asynchronous: true
    ...
    Rectangle {
        ...
        color: Config.text
        y: parent.baseHeight
        implicitHeight: Config.sc(1)
        implicitWidth: parent.width - Config.sc(40)
        anchors.horizontalCenter: parent.horizontalCenter
        visible: leftPanel.collapsed ? false : Config.toggleAppLauncher ? true : false
    }
    ...
    RowLayout {
        ...
        width: parent.width
        spacing: leftPanel.collapsed ? 0 : Config.sc(10)
        ...
        Text {
            ...
            Layout.leftMargin: leftPanel.collapsed ? parent.width / 2 - width / 2 : Config.sc(20)
        }
