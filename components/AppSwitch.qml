...
Item {
    ...
    ListView {
        id: appListView
        width: leftPanel.collapsed ? parent.width - Config.sc(20) : parent.width
        height: parent.height
        anchors.horizontalCenter: parent.horizontalCenter
        anchors.top: parent.top
        anchors.topMargin: leftPanel.collapsed ? Config.sc(20) : 0
        ...
        delegate: Item {
            ...
            height: leftPanel.collapsed ? appListView.width : Config.sc(70)
            ...
            Rectangle {
                ...
                radius: leftPanel.collapsed ? Config.sc(10) : Config.sc(25)
                scale: 1
            ...
            Item {
                ...
                Image {
                    ...
                    x: leftPanel.collapsed ? parent.width / 2 - width / 2 : Config.sc(20)
                    width: leftPanel.collapsed ? Config.sc(28) : Config.sc(52)
                    height: leftPanel.collapsed ? Config.sc(28) : Config.sc(52)
                    sourceSize.width: leftPanel.collapsed ? Config.sc(28) : Config.sc(52)
                    sourceSize.height: leftPanel.collapsed ? Config.sc(28) : Config.sc(52)
                    asynchronous: true
                ...
                MouseArea {
                    ...
                    Rectangle {
                        id: closebutton
                        height: leftPanel.collapsed ? Config.sc(14) : Config.sc(26)
                        width: leftPanel.collapsed ? Config.sc(14) : Config.sc(26)
                        radius: height / 2
                        color: Config.closeColor
                        x: leftPanel.collapsed ? parent.width - width / 2 : parent.width - width - Config.sc(20)
                        ...
                        Text {
                            ...
                            font.pointSize: leftPanel.collapsed ? Config.scFont(8) : Config.scFont(14)
                            font.bold: true
                            font.family: Config.fontFamily
