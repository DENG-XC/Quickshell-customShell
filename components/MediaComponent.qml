...
Rectangle {
    ...
    Rectangle {
        id: imageContainer
        height: Config.sc(180)
        anchors.top: parent.top
        anchors.left: parent.left
        anchors.right: parent.right
        anchors.rightMargin: Config.sc(100)
        anchors.leftMargin: ((columnLayout.width - (columnLayout.height / 4)) / 2) + Config.sc(13)
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            anchors.top: parent.top
            anchors.topMargin: Config.sc(15)
            anchors.bottom: parent.bottom
            anchors.bottomMargin: Config.sc(15)
            width: Config.sc(10)
            color: Config.background
            radius: width / 2
        }
